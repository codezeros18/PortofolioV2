...
const Contact = () => {
  return (
    <>
        <section id="contact" className="bg-navy text-light-slate font-inter h-[60vh] md:h-[80vh] lg:h-[80vh] flex items-center">
          <div className="mx-auto md:max-w-2xl lg:max-w-3xl px-6 py-24 w-full flex flex-col justify-center items-center">
            {/* Section Heading */}
            ...
            <p className="text-slate text-[18px] text-center tracking-tight md:text-[20px] max-w-2xl leading-[23px] md:leading-[26px] my-6">
